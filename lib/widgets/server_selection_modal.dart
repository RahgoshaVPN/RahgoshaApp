...
class ServerSelectionModal extends StatefulWidget {
  ServerSelectionModal(
    {super.key, this.selectedServer = '', required this.onServerSelected}
  );
  ...
  @override
  State<StatefulWidget> createState() => _ServerSelectionModalState();
}

class _ServerSelectionModalState extends State<ServerSelectionModal> {
  late Future<List<Widget>> optionsFuture;  

  @override
  void initState() {
    super.initState();
    optionsFuture = loadOptions(
